...
Patient::Patient(const std::string& name, const std::string& surname, const std::string& password, const std::string& phoneNumber, const std::string& email, bool positive, const std::string& lastTestDate)
	: Person(name, surname, password, phoneNumber, email), positive(positive), lastTestDate(lastTestDate) {}


bool Patient::isPositive() {
	return positive;
}
