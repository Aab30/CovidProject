...
protected:
	bool PatientFilterModel::filterAcceptsRow(int _sourcerow, const QModelIndex& _sourceparent) const override;  //method from QSortFilterProxyModel that we override to make the custom filter. Returns true if the row matches the filter and thus should be displayed
